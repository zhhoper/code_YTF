function distance = sim_point_set_2(pair, path, load_names, meanFeature, projection, inter_s, intra_s, type)
...
numStep = 20; % every 10 steps select one
...
for i = 1 : num
    ...
    total1 = floor(num1/numStep);
    total2 = floor(num2/numStep);
    ind1 = [1:numStep:total1*numStep];
    ind2 = [1:numStep:total2*numStep];
    f1 = f1(ind1,:);
    f2 = f2(ind2,:);
    num1 = length(ind1);
    num2 = length(ind2);
